...
def get_stock_price(symbol: str) -> dict:
    ...
    """
    url = f"https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol={symbol}&apikey=JNDQCEA6NVB1C4Y6"
    r = requests.get(url)
    return r.json()
...
# without adding rag tool to the tool list this code is used for chat node defining
